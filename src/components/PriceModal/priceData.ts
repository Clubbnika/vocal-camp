...
export const INDIVIDUAL_PLANS = [
  {
    ...
    items: [
      ...
      { id: 'master-5', name: 'Абонемент 5 год. — Вокальний майстер', label: 'Абонемент на 5 індивідуальних занять', price: 7000 },
      { id: 'master-10', name: 'Абонемент 10 год. — Вокальний майстер', label: 'Абонемент на 10 індивідуальних занять', price: 10000 },
    ]
  },
  {
    ...
    items: [
      ...
      { id: 'regular-5', name: 'Абонемент 5 год. — Звичайний викладач', label: 'Абонемент на 5 індивідуальних занять', price: 4500 },
      { id: 'regular-10', name: 'Абонемент 10 год. — Звичайний викладач', label: 'Абонемент на 10 індивідуальних занять', price: 7000 },
    ]
  }
];